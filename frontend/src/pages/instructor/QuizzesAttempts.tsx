...
const QuizzesAttempts = () => {
  ...
  const reviewedAttempts = filteredAttempts.filter(
    (quiz) => quiz.Attempt[0].score > 0
  ).length;
      ...
      <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Review and manage student quiz submissions
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFilter(
                    e.target.value as "all" | "reviewed" | "not-reviewed"
                  )
                }
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
              >
                        ...
                        quiz.Attempt.map((attempt) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="py-4 px-6">
                                <div
                                  className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium border ${getScoreColor(
                                    attempt.score
                                  )}`}
                                >
