                      ...
                      <tr key={course.course_id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-12 w-12">
                              <img
                                ...
                                src={course.course_img || "/api/placeholder/64/64"}
                                alt={course.title}
                              />
                            </div>
                            <div className="ml-4">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-700">{course.average_rating.toFixed(1)}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center bg-white rounded-lg shadow-sm p-4">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  onClick={() => navigate(`/instructor/courses?page=${pagination.currentPage - 1}`)}
                >
                  <ChevronLeft size={16} />
                </button>
                {Array.from({ length: Math.min(pagination.totalPages, 5) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => navigate(`/instructor/courses?page=${pageNum}`)}
                    >
                      {pageNum}
                    </button>
                  );
