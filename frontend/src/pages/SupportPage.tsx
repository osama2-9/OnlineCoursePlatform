  ...
  const faqs = [
    {
      ...
      answer:
        "Our support team typically responds within 2-4 hours during business hours. For urgent matters, please use our live chat option.",
    },
    {
      question: "What happens after I submit a support ticket?",
      answer:
        "You'll receive a confirmation email with your ticket details. One of our support representatives will contact you at your scheduled time.",
    },
    {
      question: "Can I change my scheduled support session?",
      answer:
        "Yes, you can reschedule by clicking the link in your confirmation email or by contacting our support team.",
    },
    {
      question: "Is there a limit to how many support requests I can submit?",
      answer:
        "There is no limit for our paid customers. For free tier users, there's a limit of 3 support tickets per month.",
    },
    {
      question: "How do I track the status of my ticket?",
      answer:
        "You can track the status of your ticket by logging into your account and navigating to the support section. All tickets and their current status will be displayed there.",
    },
    {
      question: "Can I request a specific support representative?",
      answer:
        "Yes, if you've worked with a specific representative before and would like to continue working with them, please mention their name in your support request.",
    },
  ];
            ...
            <div className="bg-blue-50 rounded-lg p-4 max-w-md mx-auto mb-6 text-left">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>
                  ...
                  {supportTopics.find((t) => t.id === selectedTopic)?.title}
                </li>
              </ul>
            </div>
            <p className="text-gray-600 mb-6">
              One of our support representatives will contact you. You will
            ...
            {filteredFaqs.length > 0 ? (
                ...
                <div key={index} className="overflow-hidden">
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out max-h-0 overflow-hidden ${
                      expandedFaq === index ? "max-h-96 pb-6 px-6" : "max-h-0"
                    }`}
                  >
              ...
              <div className="p-8 text-center">
                <p className="text-gray-600">
                  No FAQs match your search. Try a different query or{" "}
