...
const UpdateAssignmentModal = ({ isOpen, onClose, assignment }: UpdateAssignmentModalProps) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const res = await axios.put(`${API}/assignments/update-assignment/${assignment.assignment_id}`, 
        {
          ...formData,
