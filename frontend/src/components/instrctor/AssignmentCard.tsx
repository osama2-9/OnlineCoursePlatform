...
const AssignmentCard: React.FC<AssignmentCardProps> = ({ assignment, totalStudents }) => {
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1">
            <Link 
              to={`/instructor/assignments/submissions/${assignment.assignment_id}/${assignment.course_id}/${assignment.course.title}`}
            >
